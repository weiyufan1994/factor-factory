...
from .extension_registry import EXTENSION_OPERATORS, validate_extension_parameters
...
SUPPORTED_OPERATORS.update(EXTENSION_OPERATORS)
...
def validate_operator_call(name: str, args: list[dict]) -> None:
    ...
    validate_extension_parameters(name, args)
