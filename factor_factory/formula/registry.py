...
SUPPORTED_OPERATORS = {
    ...
    'stddev': {'name': 'stddev', 'aliases': ['stddev', 'std', 'ts_std'], 'arity': 2, 'category': 'time_series', 'lookahead_safe': True, 'requires_window': True, 'supports_pandas': True, 'supports_qlib': True, 'qlib_name': 'Std'},
