...
OUT_ROOT="${OUT_ROOT:-/tmp/moneyflow_v11_portfolio_policies_20260612}"
RESULT_DIR="${RESULT_DIR:-${OUT_ROOT}/results}"
SCRIPT_DIR="${SCRIPT_DIR:-/tmp/moneyflow_v11_scripts}"
...
aws s3 cp s3://yufan-data-lake/factorforge/tmp/moneyflow_v11_20260612/research_moneyflow_v11_datamart_eval.py \
...
PYTHONPATH="${WORKSPACE}" python3 "${SCRIPT_DIR}/research_moneyflow_v11_datamart_eval.py" \
  ...
  --cost-bps 20 \
  --laws miller_flow_v11_first_passage_lite_v1,miller_flow_v15_repair_confirmed_absorption_fp_v1 \
  --portfolio-policies daily_top10_equal,rebalance5_top10_equal,top10_dropout30_equal,top10_dropout30_rebalance5_equal,top10_dropout30_confirm2_equal,top10_dropout30_signal_cap \
  --universes full,middle_10_80,middle_20_90,fixed_small_20,largest_10,smallest_20,csi800,csi800_csi1000,csi2000,csi_all_share

aws s3 cp --recursive "${RESULT_DIR}" s3://yufan-data-lake/factorforge/tmp/moneyflow_v11_20260612/portfolio_policies/
