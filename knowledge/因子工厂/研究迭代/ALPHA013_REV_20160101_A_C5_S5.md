---
report_id: "ALPHA013_REV_20160101_A_C5_S5"
factor_id: "Alpha013_A_C5_S5"
decision: "iterate"
iteration_no: 1
tags:
  - "iteration"
...
# Research Iteration: Alpha013_A_C5_S5 (ALPHA013_REV_20160101_A_C5_S5)
...
- `rank_ic_mean`: `0.038743624291816055`

- `rank_ic_ir`: `0.5167171030933877`

- `pearson_ic_mean`: `0.027811976222024273`

- `pearson_ic_ir`: `0.4103549965191257`

- `group_long_short_spread_mean`: `0.0019508033266664958`

- `group_long_short_spread_ir`: `0.3683456707615826`

- `group_top_decile_mean_return`: `0.0007138283569144416`

- `group_bottom_decile_mean_return`: `-0.0012369749697520543`

- `metric_period`: `daily`

- `annualization_factor`: `252`

- `long_side_mean_return_daily`: `0.0007138283569144416`

- `long_side_annual_return`: `0.17988474594243928`

- `long_side_return_std_daily`: `0.01489417573314507`

- `long_side_annual_volatility`: `0.23643770983916987`

- `long_side_sharpe`: `0.7608124189022167`

- `long_side_max_drawdown`: `-0.4026011055282427`

- `long_side_recovery_days`: `1708`

- `long_side_turnover_mean_daily`: `0.28060230352459276`

- `turnover_mean`: `0.28060230352459276`

- `trading_cogs_daily`: `0.0008418069105737783`

- `trading_cogs_annual`: `0.21213534146459215`

- `cost_adjusted_return_daily`: `-0.00012776543798577366`

- `cost_adjusted_annual_return`: `-0.032196890372414966`

- `cost_adjusted_long_side_sharpe`: `-0.13625146737118302`

- `cost_adjusted_long_side_max_drawdown`: `-0.8270155588348196`
...
- rank_ic_mean=0.038744 is positive, so the raw cross-sectional ordering contains directional information.
- rank_ic_ir=0.517 is usable for a first-pass daily factor, but not strong enough to ignore robustness checks.
- long-side highest-score group mean return=0.179885 is positive; this is revenue evidence but no longer sufficient alone for adoption.
- long-side Sharpe=0.761 clears the candidate threshold 0.50, but still needs more evidence for official admission.
- volatility-drag adjusted growth proxy=0.151933 is positive under mean - 0.5*sigma^2.

## Weaknesses
- qlib backend is not yet consistently successful
- max_drawdown=-0.403 breaches the soft capital-cost limit -0.35; reduce drawdown before promotion.
...
- group long-short spread mean=0.001951 is positive, but this is diagnostic only because short selling and direct decile trading are not allowed.
- group long-short spread IR=0.368 is positive, but cannot justify adoption without long-side evidence.
...
- [[普通因子库/ALPHA013_REV_20160101_A_C5_S5|Factor Record]]

- [[知识库/ALPHA013_REV_20160101_A_C5_S5|Knowledge Record]]
