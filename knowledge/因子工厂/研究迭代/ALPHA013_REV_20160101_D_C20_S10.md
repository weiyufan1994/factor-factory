---
report_id: "ALPHA013_REV_20160101_D_C20_S10"
factor_id: "Alpha013_D_C20_S10"
decision: "iterate"
iteration_no: 1
tags:
  - "iteration"
...
# Research Iteration: Alpha013_D_C20_S10 (ALPHA013_REV_20160101_D_C20_S10)
...
- `rank_ic_mean`: `0.024055117203121378`

- `rank_ic_ir`: `0.2591734684912617`

- `pearson_ic_mean`: `0.018817326986983043`

- `pearson_ic_ir`: `0.23281548849623687`

- `group_long_short_spread_mean`: `0.001430612583434462`

- `group_long_short_spread_ir`: `0.2323658776785436`

- `group_top_decile_mean_return`: `0.000534351821708763`

- `group_bottom_decile_mean_return`: `-0.000896260761725699`

- `metric_period`: `daily`

- `annualization_factor`: `252`

- `long_side_mean_return_daily`: `0.000534351821708763`

- `long_side_annual_return`: `0.13465665907060825`

- `long_side_return_std_daily`: `0.014688611530016545`

- `long_side_annual_volatility`: `0.23317447927955842`

- `long_side_sharpe`: `0.5774931265490904`

- `long_side_max_drawdown`: `-0.44145714791182644`

- `long_side_recovery_days`: `1802`

- `long_side_turnover_mean_daily`: `0.10331864994747196`

- `turnover_mean`: `0.10331864994747196`

- `trading_cogs_daily`: `0.00030995594984241587`

- `trading_cogs_annual`: `0.0781088993602888`

- `cost_adjusted_return_daily`: `0.0002244747410647803`

- `cost_adjusted_annual_return`: `0.05656763474832464`

- `cost_adjusted_long_side_sharpe`: `0.2427258000754317`

- `cost_adjusted_long_side_max_drawdown`: `-0.62801100610356`
...
- rank_ic_mean=0.024055 is positive, so the raw cross-sectional ordering contains directional information.
- long-side highest-score group mean return=0.134657 is positive; this is revenue evidence but no longer sufficient alone for adoption.
- long-side Sharpe=0.577 clears the candidate threshold 0.50, but still needs more evidence for official admission.
- volatility-drag adjusted growth proxy=0.107471 is positive under mean - 0.5*sigma^2.
...
- recovery_days=1802 is longer than the soft payback limit; the factor may not survive its drawdown cycle.

## Risks
- rank_ic_ir=0.259 is positive but weak; it needs regime and turnover checks before promotion.
...
- group long-short spread mean=0.001431 is positive, but this is diagnostic only because short selling and direct decile trading are not allowed.
- group long-short spread IR=0.232 is positive, but cannot justify adoption without long-side evidence.
...
- [[普通因子库/ALPHA013_REV_20160101_D_C20_S10|Factor Record]]

- [[知识库/ALPHA013_REV_20160101_D_C20_S10|Knowledge Record]]
