---
report_id: "ALPHA013_REV_20160101_F_D1_C10_S5"
factor_id: "Alpha013_F_D1_C10_S5"
decision: "iterate"
iteration_no: 1
tags:
  - "iteration"
...
# Research Iteration: Alpha013_F_D1_C10_S5 (ALPHA013_REV_20160101_F_D1_C10_S5)
...
- backend_statuses: `{'self_quant_analyzer': 'success', 'qlib_backtest': 'failed'}`

## Evidence Metrics

- `rank_ic_mean`: `0.031037929544276577`

- `rank_ic_ir`: `0.3748960615329714`

- `pearson_ic_mean`: `0.02292628760702597`

- `pearson_ic_ir`: `0.3122851539793929`

- `group_long_short_spread_mean`: `0.001657470419465392`

- `group_long_short_spread_ir`: `0.28641342034496203`

- `group_top_decile_mean_return`: `0.0005837632594217434`

- `group_bottom_decile_mean_return`: `-0.0010737071600436488`

- `metric_period`: `daily`

- `annualization_factor`: `252`

- `long_side_mean_return_daily`: `0.0005837632594217434`

- `long_side_annual_return`: `0.14710834137427933`

- `long_side_return_std_daily`: `0.014742587102855278`

- `long_side_annual_volatility`: `0.23403131493517967`

- `long_side_sharpe`: `0.6285840055849978`

- `long_side_max_drawdown`: `-0.4409325310291684`

- `long_side_recovery_days`: `1762`

- `long_side_turnover_mean_daily`: `0.19948958762373364`

- `turnover_mean`: `0.19948958762373364`

- `trading_cogs_daily`: `0.0005984687628712009`

- `trading_cogs_annual`: `0.15081412824354262`

- `cost_adjusted_return_daily`: `-1.4553761876721606e-05`

- `cost_adjusted_annual_return`: `-0.0036675479929338447`

- `cost_adjusted_long_side_sharpe`: `-0.015677394476953425`

- `cost_adjusted_long_side_max_drawdown`: `-0.7805739052808545`
...
- rank_ic_mean=0.031038 is positive, so the raw cross-sectional ordering contains directional information.
- rank_ic_ir=0.375 is usable for a first-pass daily factor, but not strong enough to ignore robustness checks.
- long-side highest-score group mean return=0.147108 is positive; this is revenue evidence but no longer sufficient alone for adoption.
- long-side Sharpe=0.629 clears the candidate threshold 0.50, but still needs more evidence for official admission.
- volatility-drag adjusted growth proxy=0.119723 is positive under mean - 0.5*sigma^2.

## Weaknesses
- qlib backend is not yet consistently successful
- max_drawdown=-0.441 breaches the soft capital-cost limit -0.35; reduce drawdown before promotion.
...
- group long-short spread mean=0.001657 is positive, but this is diagnostic only because short selling and direct decile trading are not allowed.
- group long-short spread IR=0.286 is positive, but cannot justify adoption without long-side evidence.
...
- [[普通因子库/ALPHA013_REV_20160101_F_D1_C10_S5|Factor Record]]

- [[知识库/ALPHA013_REV_20160101_F_D1_C10_S5|Knowledge Record]]
