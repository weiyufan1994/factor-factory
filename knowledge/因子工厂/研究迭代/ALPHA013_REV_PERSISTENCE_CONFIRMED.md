---
report_id: "ALPHA013_REV_PERSISTENCE_CONFIRMED"
factor_id: "Alpha013PersistenceConfirmed"
decision: "iterate"
iteration_no: 2
tags:
  - "iteration"
...
# Research Iteration: Alpha013PersistenceConfirmed (ALPHA013_REV_PERSISTENCE_CONFIRMED)
...
- `cost_adjusted_annual_return`: `-0.1014142570565335`

- `cost_adjusted_long_side_max_drawdown`: `-0.8962809390155515`

- `cost_adjusted_long_side_recovery_days`: `5858`

- `cost_adjusted_long_side_sharpe`: `-0.42755193627148735`

- `cost_adjusted_return_daily`: `-0.00040243752800211703`

- `group_bottom_decile_mean_return`: `-0.0010160109816337345`

- `group_long_short_spread_ir`: `0.3628190712881865`

- `group_long_short_spread_mean`: `0.0016577234957443092`

- `group_top_decile_mean_return`: `0.0006417125141105742`

- `long_side_annual_return`: `0.1622139572785588`

- `long_side_annual_volatility`: `0.2372609228477751`

- `long_side_max_drawdown`: `-0.395382602236212`

- `long_side_mean_return_daily`: `0.0006437061796768207`

- `long_side_recovery_days`: `1755`

- `long_side_return_std_daily`: `0.01494603327830704`

- `long_side_sharpe`: `0.6836943704490019`

- `long_side_turnover_mean_daily`: `0.3488028290514774`

- `metric_period`: `daily`

- `pearson_ic_ir`: `0.43229235342588923`

- `pearson_ic_mean`: `0.024582050354604167`

- `rank_ic_ir`: `0.5512608748935428`

- `rank_ic_mean`: `0.034367969387030024`

- `trading_cogs_annual`: `0.26369493876291694`

- `trading_cogs_daily`: `0.0010464084871544322`

- `turnover_mean`: `0.3488028290514774`
...
- rank_ic_mean=0.034368 is positive, so the raw cross-sectional ordering contains directional information.
- rank_ic_ir=0.551 is usable for a first-pass daily factor, but not strong enough to ignore robustness checks.
- long-side highest-score group mean return=0.162214 is positive; this is revenue evidence but no longer sufficient alone for adoption.
- long-side Sharpe=0.684 clears the candidate threshold 0.50, but still needs more evidence for official admission.
- volatility-drag adjusted growth proxy=0.134068 is positive under mean - 0.5*sigma^2.
...
- group long-short spread mean=0.001658 is positive, but this is diagnostic only because short selling and direct decile trading are not allowed.
- group long-short spread IR=0.363 is positive, but cannot justify adoption without long-side evidence.
...
- [[普通因子库/ALPHA013_REV_PERSISTENCE_CONFIRMED|Factor Record]]

- [[知识库/ALPHA013_REV_PERSISTENCE_CONFIRMED|Knowledge Record]]
