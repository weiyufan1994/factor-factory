---
report_id: "ALPHA014_REV_SMOOTH10_LOWTURN_20160101"
factor_id: "Alpha014"
decision: "iterate"
iteration_no: 1
tags:
...
# Research Iteration: Alpha014 (ALPHA014_REV_SMOOTH10_LOWTURN_20160101)
...
- `rank_ic_mean`: `-0.02131388630838539`

- `rank_ic_ir`: `-0.29103968701440297`

- `pearson_ic_mean`: `-0.0090842983686752`

- `pearson_ic_ir`: `-0.15458831688328906`

- `group_long_short_spread_mean`: `7.908191215819979e-05`

- `group_long_short_spread_ir`: `0.01835110439163921`

- `group_top_decile_mean_return`: `0.000328464112198383`

- `group_bottom_decile_mean_return`: `0.0002493822000401832`

- `metric_period`: `daily`

- `annualization_factor`: `252`

- `long_side_mean_return_daily`: `0.000324802112720194`

- `long_side_annual_return`: `0.08185013240548888`

- `long_side_return_std_daily`: `0.012701717025112568`

- `long_side_annual_volatility`: `0.20163350683177805`

- `long_side_sharpe`: `0.4059351726386235`

- `long_side_max_drawdown`: `-0.3708039257982424`

- `long_side_recovery_days`: `2007`

- `long_side_turnover_mean_daily`: `0.16683972285851112`

- `turnover_mean`: `0.16683972285851112`

- `trading_cogs_daily`: `0.0005005191685755334`

- `trading_cogs_annual`: `0.1261308304810344`

- `cost_adjusted_return_daily`: `-0.00017551555860551016`

- `cost_adjusted_annual_return`: `-0.04422992076858856`

- `cost_adjusted_long_side_sharpe`: `-0.21928471488815343`

- `cost_adjusted_long_side_max_drawdown`: `-0.6706350752956827`

- `cost_adjusted_long_side_recovery_days`: `3440`

## Step5 Lessons
- Backend self_quant_analyzer reported negative rank_ic_ir=-0.29103968701440297; signal direction or construction may need review.
...
- long-side highest-score group mean return=0.081850 is positive; this is revenue evidence but no longer sufficient alone for adoption.
- volatility-drag adjusted growth proxy=0.061522 is positive under mean - 0.5*sigma^2.
...
- long-side Sharpe=0.406 is below candidate threshold 0.50
- rank_ic_mean=-0.021314 is not positive, so the raw ranking evidence does not support the current signal direction.
- rank_ic_ir=-0.291 is weak or negative.
- long-side Sharpe=0.406 is below the candidate threshold 0.50; improve risk-adjusted performance rather than raw return only.
- max_drawdown=-0.371 breaches the soft capital-cost limit -0.35; reduce drawdown before promotion.
- recovery_days=2007 is longer than the soft payback limit; the factor may not survive its drawdown cycle.
...
- group long-short spread mean=0.000079 is positive, but this is diagnostic only because short selling and direct decile trading are not allowed.
- group long-short spread IR=0.018 is only marginally positive.
...
- [[普通因子库/ALPHA014_REV_SMOOTH10_LOWTURN_20160101|Factor Record]]

- [[知识库/ALPHA014_REV_SMOOTH10_LOWTURN_20160101|Knowledge Record]]
