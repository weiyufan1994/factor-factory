---
report_id: "ALPHA014_REV_SMOOTH5_LOWTURN_20160101"
factor_id: "Alpha014_SMOOTH5_LOWTURN_20160101"
decision: "iterate"
iteration_no: 1
tags:
  - "iteration"
...
# Research Iteration: Alpha014_SMOOTH5_LOWTURN_20160101 (ALPHA014_REV_SMOOTH5_LOWTURN_20160101)
...
- `rank_ic_mean`: `-0.01576081320012689`

- `rank_ic_ir`: `-0.2208565686009639`

- `pearson_ic_mean`: `-0.005663093593482864`

- `pearson_ic_ir`: `-0.10026326621751798`

- `group_long_short_spread_mean`: `0.00024143594414779626`

- `group_long_short_spread_ir`: `0.059230957343943645`

- `group_top_decile_mean_return`: `0.0003796237684200903`

- `group_bottom_decile_mean_return`: `0.00013818782427229412`

- `metric_period`: `daily`

- `annualization_factor`: `252`

- `long_side_mean_return_daily`: `0.00037854920397151914`

- `long_side_annual_return`: `0.09539439940082282`

- `long_side_return_std_daily`: `0.012645040580815895`

- `long_side_annual_volatility`: `0.20073379617095166`

- `long_side_sharpe`: `0.4752283931280897`

- `long_side_max_drawdown`: `-0.34937849777130214`

- `long_side_recovery_days`: `1823`

- `long_side_turnover_mean_daily`: `0.2213630034561732`

- `turnover_mean`: `0.2213630034561732`

- `trading_cogs_daily`: `0.0006640890103685196`

- `trading_cogs_annual`: `0.16735043061286695`

- `cost_adjusted_return_daily`: `-0.0002852729968307616`

- `cost_adjusted_annual_return`: `-0.07188879520135193`

- `cost_adjusted_long_side_sharpe`: `-0.3580712194304125`

- `cost_adjusted_long_side_max_drawdown`: `-0.7168973037635085`

- `cost_adjusted_long_side_recovery_days`: `3440`

## Step5 Lessons
- Backend self_quant_analyzer reported negative rank_ic_ir=-0.2208565686009639; signal direction or construction may need review.
...
- long-side highest-score group mean return=0.095394 is positive; this is revenue evidence but no longer sufficient alone for adoption.
- volatility-drag adjusted growth proxy=0.075247 is positive under mean - 0.5*sigma^2.
- max_drawdown=-0.349 is within the soft capital-cost limit -0.35.
...
- long-side Sharpe=0.475 is below candidate threshold 0.50
- rank_ic_mean=-0.015761 is not positive, so the raw ranking evidence does not support the current signal direction.
- rank_ic_ir=-0.221 is weak or negative.
- long-side Sharpe=0.475 is below the candidate threshold 0.50; improve risk-adjusted performance rather than raw return only.
- recovery_days=1823 is longer than the soft payback limit; the factor may not survive its drawdown cycle.
...
- group long-short spread mean=0.000241 is positive, but this is diagnostic only because short selling and direct decile trading are not allowed.
- group long-short spread IR=0.059 is only marginally positive.
...
- [[普通因子库/ALPHA014_REV_SMOOTH5_LOWTURN_20160101|Factor Record]]

- [[知识库/ALPHA014_REV_SMOOTH5_LOWTURN_20160101|Knowledge Record]]
