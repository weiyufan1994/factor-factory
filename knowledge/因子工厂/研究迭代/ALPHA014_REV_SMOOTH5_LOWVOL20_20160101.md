---
report_id: "ALPHA014_REV_SMOOTH5_LOWVOL20_20160101"
factor_id: "Alpha014"
decision: "iterate"
iteration_no: 1
tags:
...
# Research Iteration: Alpha014 (ALPHA014_REV_SMOOTH5_LOWVOL20_20160101)
...
- `rank_ic_mean`: `-0.0005621001849299126`

- `rank_ic_ir`: `-0.007483271312040161`

- `pearson_ic_mean`: `0.00585886651214767`

- `pearson_ic_ir`: `0.09756267131183363`

- `group_long_short_spread_mean`: `0.0007093873544303999`

- `group_long_short_spread_ir`: `0.17354670415785228`

- `group_top_decile_mean_return`: `0.00030733113578523797`

- `group_bottom_decile_mean_return`: `-0.00040205621864516195`

- `metric_period`: `daily`

- `annualization_factor`: `252`

- `long_side_mean_return_daily`: `0.00030656229005195427`

- `long_side_annual_return`: `0.07725369709309247`

- `long_side_return_std_daily`: `0.01255098284120948`

- `long_side_annual_volatility`: `0.19924067584367497`

- `long_side_sharpe`: `0.38774058944522977`

- `long_side_max_drawdown`: `-0.3809594984336456`

- `long_side_recovery_days`: `1781`

- `long_side_turnover_mean_daily`: `0.20269297992123447`

- `turnover_mean`: `0.20269297992123447`

- `trading_cogs_daily`: `0.0006080789397637034`

- `trading_cogs_annual`: `0.15323589282045327`

- `cost_adjusted_return_daily`: `-0.000301271752837096`

- `cost_adjusted_annual_return`: `-0.07592048171494818`

- `cost_adjusted_long_side_sharpe`: `-0.38115411299668556`

- `cost_adjusted_long_side_max_drawdown`: `-0.7486932465825595`

- `cost_adjusted_long_side_recovery_days`: `3440`

## Step5 Lessons
- Backend self_quant_analyzer reported negative rank_ic_ir=-0.007483271312040161; signal direction or construction may need review.
...
- long-side highest-score group mean return=0.077254 is positive; this is revenue evidence but no longer sufficient alone for adoption.
- volatility-drag adjusted growth proxy=0.057405 is positive under mean - 0.5*sigma^2.
...
- long-side Sharpe=0.388 is below candidate threshold 0.50
- rank_ic_mean=-0.000562 is not positive, so the raw ranking evidence does not support the current signal direction.
- rank_ic_ir=-0.007 is weak or negative.
- long-side Sharpe=0.388 is below the candidate threshold 0.50; improve risk-adjusted performance rather than raw return only.
- max_drawdown=-0.381 breaches the soft capital-cost limit -0.35; reduce drawdown before promotion.
- recovery_days=1781 is longer than the soft payback limit; the factor may not survive its drawdown cycle.

## Risks
- group long-short spread mean=0.000709 is positive, but this is diagnostic only because short selling and direct decile trading are not allowed.
- group long-short spread IR=0.174 is only marginally positive.
...
- [[普通因子库/ALPHA014_REV_SMOOTH5_LOWVOL20_20160101|Factor Record]]

- [[知识库/ALPHA014_REV_SMOOTH5_LOWVOL20_20160101|Knowledge Record]]
