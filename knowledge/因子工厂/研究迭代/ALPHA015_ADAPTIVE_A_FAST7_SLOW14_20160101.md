---
report_id: "ALPHA015_ADAPTIVE_A_FAST7_SLOW14_20160101"
factor_id: "Alpha015"
decision: "iterate"
iteration_no: 1
tags:
...
# Research Iteration: Alpha015 (ALPHA015_ADAPTIVE_A_FAST7_SLOW14_20160101)
...
- `rank_ic_mean`: `0.003726512852350453`

- `rank_ic_ir`: `0.03786405689995637`

- `pearson_ic_mean`: `-0.0003675044844949587`

- `pearson_ic_ir`: `-0.0045623890810858984`

- `group_long_short_spread_mean`: `-0.00012292809763689118`

- `group_long_short_spread_ir`: `-0.01999562065939199`

- `group_top_decile_mean_return`: `0.0002137200300471508`

- `group_bottom_decile_mean_return`: `0.000336648127684042`

- `metric_period`: `daily`

- `annualization_factor`: `252`

- `long_side_mean_return_daily`: `0.00021418354385745826`

- `long_side_annual_return`: `0.05397425305207948`

- `long_side_return_std_daily`: `0.013033082375346545`

- `long_side_annual_volatility`: `0.2068937686907156`

- `long_side_sharpe`: `0.26087906558831797`

- `long_side_max_drawdown`: `-0.4939194404483397`

- `long_side_recovery_days`: `2113`

- `long_side_turnover_mean_daily`: `0.13816977827708`

- `turnover_mean`: `0.13816977827708`

- `trading_cogs_daily`: `0.00041450933483123996`

- `trading_cogs_annual`: `0.10445635237747247`

- `cost_adjusted_return_daily`: `-0.0002001583800954168`

- `cost_adjusted_annual_return`: `-0.05043991178404503`

- `cost_adjusted_long_side_sharpe`: `-0.2438393237498934`

- `cost_adjusted_long_side_max_drawdown`: `-0.7051212632017438`
...
- rank_ic_mean=0.003727 is positive, so the raw cross-sectional ordering contains directional information.
- long-side highest-score group mean return=0.053974 is positive; this is revenue evidence but no longer sufficient alone for adoption.
- volatility-drag adjusted growth proxy=0.032572 is positive under mean - 0.5*sigma^2.

## Weaknesses
- current run is still partial rather than fully validated
- qlib backend is not yet consistently successful
- long-side Sharpe=0.261 is below candidate threshold 0.50
- long-side Sharpe=0.261 is below the candidate threshold 0.50; improve risk-adjusted performance rather than raw return only.
- max_drawdown=-0.494 breaches the soft capital-cost limit -0.35; reduce drawdown before promotion.
- recovery_days=2113 is longer than the soft payback limit; the factor may not survive its drawdown cycle.

## Risks
- rank_ic_ir=0.038 is positive but weak; it needs regime and turnover checks before promotion.
...
- group long-short spread mean=-0.000123 is not positive; use this only to diagnose expression monotonicity, not as a trading objective.
- group long-short spread IR=-0.020 is not supportive as a monotonicity diagnostic.
...
- [[普通因子库/ALPHA015_ADAPTIVE_A_FAST7_SLOW14_20160101|Factor Record]]

- [[知识库/ALPHA015_ADAPTIVE_A_FAST7_SLOW14_20160101|Knowledge Record]]
