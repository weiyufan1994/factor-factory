---
report_id: "ALPHA015_REGIME_R02_CORR7_HIGHTURN_20160101"
factor_id: "Alpha015"
decision: "iterate"
iteration_no: 1
tags:
...
# Research Iteration: Alpha015 (ALPHA015_REGIME_R02_CORR7_HIGHTURN_20160101)
...
- `rank_ic_mean`: `0.0667787181384232`

- `rank_ic_ir`: `0.43081596738952227`

- `pearson_ic_mean`: `0.05026976912508831`

- `pearson_ic_ir`: `0.3852015021304772`

- `group_long_short_spread_mean`: `0.0038234115095705824`

- `group_long_short_spread_ir`: `0.35462751261240427`

- `group_top_decile_mean_return`: `0.0004942501578874251`

- `group_bottom_decile_mean_return`: `-0.0033291613516831563`

- `metric_period`: `daily`

- `annualization_factor`: `252`

- `long_side_mean_return_daily`: `0.0004940607924606449`

- `long_side_annual_return`: `0.12450331970008252`

- `long_side_return_std_daily`: `0.010565980406458429`

- `long_side_annual_volatility`: `0.16772973907842098`

- `long_side_sharpe`: `0.7422853000556554`

- `long_side_max_drawdown`: `-0.27555060615406324`

- `long_side_recovery_days`: `520`

- `long_side_turnover_mean_daily`: `0.22887969041765796`

- `turnover_mean`: `0.22887969041765796`

- `trading_cogs_daily`: `0.0006866390712529739`

- `trading_cogs_annual`: `0.17303304595574942`

- `cost_adjusted_return_daily`: `-0.000192302520129175`

- `cost_adjusted_annual_return`: `-0.0484602350725521`

- `cost_adjusted_long_side_sharpe`: `-0.28868655365895507`

- `cost_adjusted_long_side_max_drawdown`: `-0.6445667209093644`

- `cost_adjusted_long_side_recovery_days`: `3436`
...
- rank_ic_mean=0.066779 is positive, so the raw cross-sectional ordering contains directional information.
- rank_ic_ir=0.431 is usable for a first-pass daily factor, but not strong enough to ignore robustness checks.
- long-side highest-score group mean return=0.124503 is positive; this is revenue evidence but no longer sufficient alone for adoption.
- long-side Sharpe=0.742 clears the candidate threshold 0.50, but still needs more evidence for official admission.
- volatility-drag adjusted growth proxy=0.110437 is positive under mean - 0.5*sigma^2.
- max_drawdown=-0.276 is within the soft capital-cost limit -0.35.

## Weaknesses
- qlib backend is not yet consistently successful
- recovery_days=520 is longer than the soft payback limit; the factor may not survive its drawdown cycle.
...
- group long-short spread mean=0.003823 is positive, but this is diagnostic only because short selling and direct decile trading are not allowed.
- group long-short spread IR=0.355 is positive, but cannot justify adoption without long-side evidence.
...
- [[普通因子库/ALPHA015_REGIME_R02_CORR7_HIGHTURN_20160101|Factor Record]]

- [[知识库/ALPHA015_REGIME_R02_CORR7_HIGHTURN_20160101|Knowledge Record]]
