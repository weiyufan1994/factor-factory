---
report_id: "ALPHA015_REV_CORR3_MEAN5_RANK_20160101"
factor_id: "Alpha015"
decision: "iterate"
iteration_no: 1
tags:
...
# Research Iteration: Alpha015 (ALPHA015_REV_CORR3_MEAN5_RANK_20160101)
...
- `rank_ic_mean`: `0.037377786625013294`

- `rank_ic_ir`: `0.5607479009492257`

- `pearson_ic_mean`: `0.025714613081452536`

- `pearson_ic_ir`: `0.4262561255737217`

- `group_long_short_spread_mean`: `0.001896189701798226`

- `group_long_short_spread_ir`: `0.39039985824044565`

- `group_top_decile_mean_return`: `0.0003733653935663947`

- `group_bottom_decile_mean_return`: `-0.0015228243082318316`

- `metric_period`: `daily`

- `annualization_factor`: `252`

- `long_side_mean_return_daily`: `0.0003726514280582381`

- `long_side_annual_return`: `0.093908159870676`

- `long_side_return_std_daily`: `0.0137585034956066`

- `long_side_annual_volatility`: `0.2184094719707275`

- `long_side_sharpe`: `0.4299637695349684`

- `long_side_max_drawdown`: `-0.3933920005132866`

- `long_side_recovery_days`: `1755`

- `long_side_turnover_mean_daily`: `0.32976282335099033`

- `turnover_mean`: `0.32976282335099033`

- `trading_cogs_daily`: `0.000989288470052971`

- `trading_cogs_annual`: `0.24930069445334868`

- `cost_adjusted_return_daily`: `-0.000616240692447436`

- `cost_adjusted_annual_return`: `-0.15529265449675386`

- `cost_adjusted_long_side_sharpe`: `-0.7110121956064696`

- `cost_adjusted_long_side_max_drawdown`: `-0.881077942635134`
...
- rank_ic_mean=0.037378 is positive, so the raw cross-sectional ordering contains directional information.
- rank_ic_ir=0.561 is usable for a first-pass daily factor, but not strong enough to ignore robustness checks.
- long-side highest-score group mean return=0.093908 is positive; this is revenue evidence but no longer sufficient alone for adoption.
- volatility-drag adjusted growth proxy=0.070057 is positive under mean - 0.5*sigma^2.

## Weaknesses
- current run is still partial rather than fully validated
- qlib backend is not yet consistently successful
- long-side Sharpe=0.430 is below candidate threshold 0.50
- long-side Sharpe=0.430 is below the candidate threshold 0.50; improve risk-adjusted performance rather than raw return only.
- max_drawdown=-0.393 breaches the soft capital-cost limit -0.35; reduce drawdown before promotion.
...
- group long-short spread mean=0.001896 is positive, but this is diagnostic only because short selling and direct decile trading are not allowed.
- group long-short spread IR=0.390 is positive, but cannot justify adoption without long-side evidence.
...
- [[普通因子库/ALPHA015_REV_CORR3_MEAN5_RANK_20160101|Factor Record]]

- [[知识库/ALPHA015_REV_CORR3_MEAN5_RANK_20160101|Knowledge Record]]
