---
report_id: "ALPHA015_RISK_B_HIGHAMOUNT_HALFLOWTURN_20160101"
factor_id: "Alpha015"
decision: "iterate"
iteration_no: 1
tags:
...
# Research Iteration: Alpha015 (ALPHA015_RISK_B_HIGHAMOUNT_HALFLOWTURN_20160101)
...
- `rank_ic_mean`: `0.06490036686373138`

- `rank_ic_ir`: `0.5625745334855166`

- `pearson_ic_mean`: `0.04131766712595829`

- `pearson_ic_ir`: `0.4114414577101481`

- `group_long_short_spread_mean`: `0.002624831639545332`

- `group_long_short_spread_ir`: `0.3168841195320012`

- `group_top_decile_mean_return`: `0.0008996959365564571`

- `group_bottom_decile_mean_return`: `-0.0017251357029888746`

- `metric_period`: `daily`

- `annualization_factor`: `252`

- `long_side_mean_return_daily`: `0.0008992589526871529`

- `long_side_annual_return`: `0.22661325607716254`

- `long_side_return_std_daily`: `0.014709771730034958`

- `long_side_annual_volatility`: `0.23351038704120505`

- `long_side_sharpe`: `0.970463279807654`

- `long_side_max_drawdown`: `-0.3923059989075708`

- `long_side_recovery_days`: `704`

- `long_side_turnover_mean_daily`: `0.24529725568351332`

- `turnover_mean`: `0.24529725568351332`

- `trading_cogs_daily`: `0.00073589176705054`

- `trading_cogs_annual`: `0.18544472529673608`

- `cost_adjusted_return_daily`: `0.00016366272449888224`

- `cost_adjusted_annual_return`: `0.04124300657371832`

- `cost_adjusted_long_side_sharpe`: `0.17655436962857343`

- `cost_adjusted_long_side_max_drawdown`: `-0.6128232573078414`
...
- rank_ic_mean=0.064900 is positive, so the raw cross-sectional ordering contains directional information.
- rank_ic_ir=0.563 is usable for a first-pass daily factor, but not strong enough to ignore robustness checks.
- long-side highest-score group mean return=0.226613 is positive; this is revenue evidence but no longer sufficient alone for adoption.
- long-side Sharpe=0.970 clears the official threshold 0.80.
- volatility-drag adjusted growth proxy=0.199350 is positive under mean - 0.5*sigma^2.

## Weaknesses
- qlib backend is not yet consistently successful
- max_drawdown=-0.392 breaches the soft capital-cost limit -0.35; reduce drawdown before promotion.
...
- group long-short spread mean=0.002625 is positive, but this is diagnostic only because short selling and direct decile trading are not allowed.
...
- [[普通因子库/ALPHA015_RISK_B_HIGHAMOUNT_HALFLOWTURN_20160101|Factor Record]]

- [[知识库/ALPHA015_RISK_B_HIGHAMOUNT_HALFLOWTURN_20160101|Knowledge Record]]
