---
report_id: "ALPHA015_RISK_B_HIGHAMOUNT_LOWTURN_20160101"
factor_id: "Alpha015"
decision: "iterate"
iteration_no: 1
tags:
...
# Research Iteration: Alpha015 (ALPHA015_RISK_B_HIGHAMOUNT_LOWTURN_20160101)
...
- `rank_ic_mean`: `1.320290643019072e-05`

- `rank_ic_ir`: `0.00011032430667622365`

- `pearson_ic_mean`: `-0.007436154194101686`

- `pearson_ic_ir`: `-0.07328351980514103`

- `group_long_short_spread_mean`: `-0.0013076183074879392`

- `group_long_short_spread_ir`: `-0.15037955216324891`

- `group_top_decile_mean_return`: `-0.0012981565029013885`

- `group_bottom_decile_mean_return`: `9.461804586550698e-06`

- `metric_period`: `daily`

- `annualization_factor`: `252`

- `long_side_mean_return_daily`: `-0.0012960489064850226`

- `long_side_annual_return`: `-0.3266043244342257`

- `long_side_return_std_daily`: `0.015333242329677641`

- `long_side_annual_volatility`: `0.2434076759796942`

- `long_side_sharpe`: `-1.3417996089058097`

- `long_side_max_drawdown`: `-0.9780865710572629`

- `long_side_recovery_days`: `3440`

- `long_side_turnover_mean_daily`: `0.2874877347611948`

- `turnover_mean`: `0.2874877347611948`

- `trading_cogs_daily`: `0.0008624632042835845`

- `trading_cogs_annual`: `0.21734072747946329`

- `cost_adjusted_return_daily`: `-0.0021581657400038343`

- `cost_adjusted_annual_return`: `-0.5438577664809663`

- `cost_adjusted_long_side_sharpe`: `-2.2343330399611343`

- `cost_adjusted_long_side_max_drawdown`: `-0.99708002604582`
...
- rank_ic_mean=0.000013 is positive, so the raw cross-sectional ordering contains directional information.
...
- long-side Sharpe=-1.342 is below candidate threshold 0.50
- long-side highest-score group mean return=-0.326604 is not positive; this blocks adoption regardless of short-leg or long-short diagnostics.
- long-side Sharpe=-1.342 is below the candidate threshold 0.50; improve risk-adjusted performance rather than raw return only.
- volatility-drag adjusted growth proxy=-0.356228 is not positive; volatility COGS may consume the apparent return.
- max_drawdown=-0.978 breaches the soft capital-cost limit -0.35; reduce drawdown before promotion.
...
## Risks
- rank_ic_ir=0.000 is positive but weak; it needs regime and turnover checks before promotion.
- group long-short spread mean=-0.001308 is not positive; use this only to diagnose expression monotonicity, not as a trading objective.
- group long-short spread IR=-0.150 is not supportive as a monotonicity diagnostic.
...
- [[普通因子库/ALPHA015_RISK_B_HIGHAMOUNT_LOWTURN_20160101|Factor Record]]

- [[知识库/ALPHA015_RISK_B_HIGHAMOUNT_LOWTURN_20160101|Knowledge Record]]
