---
report_id: "ALPHA015_SWEEP_TURNPEN_A025_20160101"
factor_id: "Alpha015"
decision: "iterate"
iteration_no: 1
tags:
...
# Research Iteration: Alpha015 (ALPHA015_SWEEP_TURNPEN_A025_20160101)
...
- `rank_ic_mean`: `0.048304794457909174`

- `rank_ic_ir`: `0.4241680368446772`

- `pearson_ic_mean`: `0.022350700209739786`

- `pearson_ic_ir`: `0.23892035575372061`

- `group_long_short_spread_mean`: `0.0011114917657024136`

- `group_long_short_spread_ir`: `0.1358529307204807`

- `group_top_decile_mean_return`: `0.000885999182404752`

- `group_bottom_decile_mean_return`: `-0.00022549258329766168`

- `metric_period`: `daily`

- `annualization_factor`: `252`

- `long_side_mean_return_daily`: `0.0008856252524504484`

- `long_side_annual_return`: `0.22317756361751298`

- `long_side_return_std_daily`: `0.01493200014169206`

- `long_side_annual_volatility`: `0.23703815371019052`

- `long_side_sharpe`: `0.9415259110158954`

- `long_side_max_drawdown`: `-0.4018021571924859`

- `long_side_recovery_days`: `709`

- `long_side_turnover_mean_daily`: `0.2372369977267521`

- `turnover_mean`: `0.2372369977267521`

- `trading_cogs_daily`: `0.0007117109931802563`

- `trading_cogs_annual`: `0.17935117028142458`

- `cost_adjusted_return_daily`: `0.0001742000869782966`

- `cost_adjusted_annual_return`: `0.04389842191853074`

- `cost_adjusted_long_side_sharpe`: `0.18514364805743042`

- `cost_adjusted_long_side_max_drawdown`: `-0.618915528619663`
...
- rank_ic_mean=0.048305 is positive, so the raw cross-sectional ordering contains directional information.
- rank_ic_ir=0.424 is usable for a first-pass daily factor, but not strong enough to ignore robustness checks.
- long-side highest-score group mean return=0.223178 is positive; this is revenue evidence but no longer sufficient alone for adoption.
- long-side Sharpe=0.942 clears the official threshold 0.80.
- volatility-drag adjusted growth proxy=0.195084 is positive under mean - 0.5*sigma^2.
...
- group long-short spread mean=0.001111 is positive, but this is diagnostic only because short selling and direct decile trading are not allowed.
- group long-short spread IR=0.136 is only marginally positive.
...
- [[普通因子库/ALPHA015_SWEEP_TURNPEN_A025_20160101|Factor Record]]

- [[知识库/ALPHA015_SWEEP_TURNPEN_A025_20160101|Knowledge Record]]
