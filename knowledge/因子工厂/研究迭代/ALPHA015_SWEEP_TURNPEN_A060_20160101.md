---
report_id: "ALPHA015_SWEEP_TURNPEN_A060_20160101"
factor_id: "Alpha015"
decision: "iterate"
iteration_no: 1
tags:
...
# Research Iteration: Alpha015 (ALPHA015_SWEEP_TURNPEN_A060_20160101)
...
- `rank_ic_mean`: `0.0685250054199578`

- `rank_ic_ir`: `0.5886396341326482`

- `pearson_ic_mean`: `0.04604567780578648`

- `pearson_ic_ir`: `0.443914066671163`

- `group_long_short_spread_mean`: `0.0031093857716497984`

- `group_long_short_spread_ir`: `0.3672710820408846`

- `group_top_decile_mean_return`: `0.0008913073012829732`

- `group_bottom_decile_mean_return`: `-0.0022180784703668245`

- `metric_period`: `daily`

- `annualization_factor`: `252`

- `long_side_mean_return_daily`: `0.0008903126199971455`

- `long_side_annual_return`: `0.22435878023928066`

- `long_side_return_std_daily`: `0.014646927424707494`

- `long_side_annual_volatility`: `0.23251276462192658`

- `long_side_sharpe`: `0.9649310247723194`

- `long_side_max_drawdown`: `-0.3892175247274754`

- `long_side_recovery_days`: `704`

- `long_side_turnover_mean_daily`: `0.24761874420258714`

- `turnover_mean`: `0.24761874420258714`

- `trading_cogs_daily`: `0.0007428562326077615`

- `trading_cogs_annual`: `0.1871997706171559`

- `cost_adjusted_return_daily`: `0.0001477547232257727`

- `cost_adjusted_annual_return`: `0.03723419025289472`

- `cost_adjusted_long_side_sharpe`: `0.16008189502739678`

- `cost_adjusted_long_side_max_drawdown`: `-0.6202596751114645`
...
- rank_ic_mean=0.068525 is positive, so the raw cross-sectional ordering contains directional information.
- rank_ic_ir=0.589 is usable for a first-pass daily factor, but not strong enough to ignore robustness checks.
- long-side highest-score group mean return=0.224359 is positive; this is revenue evidence but no longer sufficient alone for adoption.
- long-side Sharpe=0.965 clears the official threshold 0.80.
- volatility-drag adjusted growth proxy=0.197328 is positive under mean - 0.5*sigma^2.

## Weaknesses
- qlib backend is not yet consistently successful
- max_drawdown=-0.389 breaches the soft capital-cost limit -0.35; reduce drawdown before promotion.
...
- group long-short spread mean=0.003109 is positive, but this is diagnostic only because short selling and direct decile trading are not allowed.
...
- [[普通因子库/ALPHA015_SWEEP_TURNPEN_A060_20160101|Factor Record]]

- [[知识库/ALPHA015_SWEEP_TURNPEN_A060_20160101|Knowledge Record]]
