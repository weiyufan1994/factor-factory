---
report_id: "ALPHA015_SWEEP_TURNPEN_A075_20160101"
factor_id: "Alpha015"
decision: "iterate"
iteration_no: 1
tags:
...
# Research Iteration: Alpha015 (ALPHA015_SWEEP_TURNPEN_A075_20160101)
...
- `rank_ic_mean`: `0.07231333409860713`

- `rank_ic_ir`: `0.6126623239988884`

- `pearson_ic_mean`: `0.05113430511446602`

- `pearson_ic_ir`: `0.47325061719801137`

- `group_long_short_spread_mean`: `0.0036178904859639153`

- `group_long_short_spread_ir`: `0.41472906898706924`

- `group_top_decile_mean_return`: `0.0008878076332334148`

- `group_bottom_decile_mean_return`: `-0.0027300828527305`

- `metric_period`: `daily`

- `annualization_factor`: `252`

- `long_side_mean_return_daily`: `0.0008869992608753921`

- `long_side_annual_return`: `0.22352381374059882`

- `long_side_return_std_daily`: `0.014566222453444655`

- `long_side_annual_volatility`: `0.23123161292075806`

- `long_side_sharpe`: `0.9666663261013508`

- `long_side_max_drawdown`: `-0.38511844762671277`

- `long_side_recovery_days`: `709`

- `long_side_turnover_mean_daily`: `0.2505596278949081`

- `turnover_mean`: `0.2505596278949081`

- `trading_cogs_daily`: `0.0007516788836847243`

- `trading_cogs_annual`: `0.18942307868855054`

- `cost_adjusted_return_daily`: `0.00013562225626042064`

- `cost_adjusted_annual_return`: `0.034176808577626`

- `cost_adjusted_long_side_sharpe`: `0.14775106028274199`

- `cost_adjusted_long_side_max_drawdown`: `-0.6248016324310555`
...
- rank_ic_mean=0.072313 is positive, so the raw cross-sectional ordering contains directional information.
- rank_ic_ir=0.613 is usable for a first-pass daily factor, but not strong enough to ignore robustness checks.
- long-side highest-score group mean return=0.223524 is positive; this is revenue evidence but no longer sufficient alone for adoption.
- long-side Sharpe=0.967 clears the official threshold 0.80.
- volatility-drag adjusted growth proxy=0.196790 is positive under mean - 0.5*sigma^2.

## Weaknesses
- qlib backend is not yet consistently successful
- max_drawdown=-0.385 breaches the soft capital-cost limit -0.35; reduce drawdown before promotion.
- recovery_days=709 is longer than the soft payback limit; the factor may not survive its drawdown cycle.
...
- group long-short spread mean=0.003618 is positive, but this is diagnostic only because short selling and direct decile trading are not allowed.
- group long-short spread IR=0.415 is positive, but cannot justify adoption without long-side evidence.
...
- [[普通因子库/ALPHA015_SWEEP_TURNPEN_A075_20160101|Factor Record]]

- [[知识库/ALPHA015_SWEEP_TURNPEN_A075_20160101|Knowledge Record]]
