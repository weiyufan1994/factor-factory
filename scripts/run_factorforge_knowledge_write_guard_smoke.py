...
def main() -> int:
    ...
    results.append(expect('alpha101_registry_blocks_without_workspace', [
        sys.executable,
        'factor_research/alpha101_batch/alpha101_batch_qlib_20260611/scripts/build_alpha101_registry.py',
    ...
    results.append(expect('alpha101_batch_judge_blocks_without_workspace', [
        sys.executable,
        'factor_research/alpha101_batch/alpha101_batch_qlib_20260611/scripts/run_alpha101_qlib_batch_judge.py',
    ], 1, BLOCK_REPO_ROOT_DATA_WRITE_FORBIDDEN))
    ...
    results.append(expect('alpha101_queue_blocks_without_workspace', [
        sys.executable,
        'factor_research/alpha101_batch/alpha101_batch_qlib_20260611/scripts/build_alpha101_research_queue.py',
    ], 1, BLOCK_REPO_ROOT_DATA_WRITE_FORBIDDEN))
