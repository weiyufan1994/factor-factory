    ...
    metadata = {
        ...
        **step3b_cache_identity,
        ...
        'lineage': {
            ...
            'implementation_plan_master_ref': f'objects/implementation_plan_master/implementation_plan_master__{report_id}.json',
            'handoff_to_step4_ref': f'objects/handoff/handoff_to_step4__{report_id}.json',
            'formal_factor_values_owner': 'Step4',
        },
