...
def generate_first_run_factor_values(
    ...
    metadata = {
        ...
        **step3b_cache_identity,
        ...
        'sample_window': actual_window,
        'lineage': {
            'producer': 'step3b_sample_proof',
            'upstream_producer': (artifact_identity or {}).get('producer'),
            'upstream_artifact_role': (artifact_identity or {}).get('artifact_role'),
            'source_report_id': report_id,
            'source_factor_id': factor_id,
            'step3a_snapshot_source': (local_inputs or {}).get('snapshot_source'),
            'step3a_daily_format': daily_selected_format,
            'data_api_contract_version': 'factorforge_step4_data_contract_v1',
        },
