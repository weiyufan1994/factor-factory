...
def test_clean_daily_inaccessible_local_candidate_falls_through_to_catalog(
    ...
    inaccessible = Path(
        "/home/researcher/projects/factor-factory-data-api/data/clean/daily_clean.parquet"
    )
    absent_candidates = {
        Path(
            "/Users/researcher/projects/factor-factory-data-api/data/clean/daily_clean.parquet"
        ),
    }
