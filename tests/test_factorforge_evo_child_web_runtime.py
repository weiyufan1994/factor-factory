...
def test_pre_release_projection_scrubs_host_source_locations() -> None:
    payload = {
        "local_input_paths": {
            ...
            "daily_input_meta_json": "/home/researcher/private/meta.json",
        ...
        "coverage_checks": [
            {"status": "ready", "catalog_path": "/home/researcher/private/catalog.json"}
        ],
        "step4_data_contract": {
            "catalog_path": "/home/researcher/private/catalog.json",
            "full_queries": {
                "clean_daily_bar": {
                    "dataset": "clean_daily_bar",
                    "start_date": "20200101",
    ...
    assert "/home/researcher/private" not in serialized
